...
#define IOCTL_GAYM_QUERY_ROUTE_STATE ((ULONG)CTL_CODE(GAYM_IOCTL_TYPE, 0x809, METHOD_BUFFERED, FILE_READ_ACCESS))
...
#define GAYM_CONTROL_ROUTE_FLAG_NONE                         0x00000000u
#define GAYM_CONTROL_ROUTE_FLAG_BOUND_FILTER_CONTEXT         0x00000001u
#define GAYM_CONTROL_ROUTE_FLAG_FILTER_IN_D0                 0x00000002u
#define GAYM_CONTROL_ROUTE_FLAG_DEV_DIAGNOSTICS_ENABLED      0x00000004u
#define GAYM_CONTROL_ROUTE_FLAG_OBSERVATION_CAPTURE_SUPPORTED 0x00000008u

#pragma pack(push, 1)
typedef struct _GAYM_CONTROL_ROUTE_STATE {
    ULONG  Size;
    ULONG  Flags;
    USHORT VendorId;
    USHORT ProductId;
    ...
    ULONG  DriverBuildStamp;
    ULONG  Reserved;
} GAYM_CONTROL_ROUTE_STATE, *PGAYM_CONTROL_ROUTE_STATE;
...
GAYM_STATIC_ASSERT(control_route_state_size, sizeof(GAYM_CONTROL_ROUTE_STATE) == 24);
