/*
 * GaYmFilter - Device table and native HID report translator.
 *
 * The supported controller is the Xbox USB XInput HID child (PID 0x02FF).
 * The translator converts the generic GAYM_REPORT into the device's native
...
/* ═══════════════════════════════════════════════════════════════════
 * Device table - single supported VID/PID pair for the MVP
 * ═══════════════════════════════════════════════════════════════════ */
static const GAYM_DEVICE_DESCRIPTOR g_DeviceTable[] =
{
    /* Xbox USB XInput HID child */
